...
var Obfuscator = /** @class */ (function () {
    ...
    Obfuscator.prototype.render = function (characters, exclude) {
        ...
        if (!characters.length)
            return this.value;
        return mapString(this.value, function (char, index) {
             ...
             */
            return _this.bitmap[index] ? sample(characters) : char;
        });
    };
    /**
